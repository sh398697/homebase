...
from models import db, Team, Coach, Player, Guardian, Message, PlayerGameAvailability, PlayerGuardian
from app import app
...
if __name__ == '__main__':
    with app.app_context():
        ...
        # Create teams
        team1 = Team(name="US Beef Newark")
        team2 = Team(name="GenWealth Giants")
